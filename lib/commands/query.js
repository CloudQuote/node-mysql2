...
class Query extends Command {
  ...
  readField(packet, connection) {
    ...
    if (this._receivedFieldsCount === this._fieldCount) {
      ...
      this._rowParser = new (this.useFastTextParser
        ? getFastTextParser(fields, this.options, connection.config)
        : getTextParser(fields, this.options, connection.config))(fields);
